...
func CORS(cfg *config.Config) gin.HandlerFunc {
	...
	return func(c *gin.Context) {
		...
		headers.Set("Access-Control-Allow-Headers", "Authorization, Content-Type, Content-Length, Accept-Encoding, accept, origin, Cache-Control, X-API-Key, X-PrivateDeploy-Token, X-Requested-With, Idempotency-Key")
