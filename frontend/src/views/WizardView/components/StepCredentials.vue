    ...
    <template v-if="method === 'ssh'">
      ...
      <div class="grid gap-4 grid-cols-2">
        ...
        <div v-else class="form-field col-span-2">
          ...
          <textarea v-model="sshForm.privateKey" class="w-full h-20 px-3 py-2 text-xs font-mono border rounded resize-none bg-canvas" placeholder="-----BEGIN OPENSSH PRIVATE KEY-----" />
        </div>
      </div>
