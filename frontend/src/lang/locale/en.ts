export default {
  ...
  kernel: {
    ...
    outbounds: {
      ...
      wireguard_server_port: 'Server Port',
      wireguard_local_address: 'Local Address',
      wireguard_private_key: 'Private Key',
      wireguard_peer_public_key: 'Peer Public Key',
      wireguard_pre_shared_key: 'Pre-shared Key',
      wireguard_mtu: 'MTU',
      wireguard_persistent_keepalive_interval: 'Persistent Keepalive(s)',
