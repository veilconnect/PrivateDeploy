export default {
  ...
  kernel: {
    ...
    outbounds: {
      ...
      urltest: '自动选择',
      wireguard: 'WireGuard',
      wireguard_server: '服务器地址',
      wireguard_server_port: '服务器端口',
      wireguard_local_address: '本地地址',
      wireguard_private_key: '私钥',
      wireguard_peer_public_key: '对端公钥',
      wireguard_pre_shared_key: '预共享密钥',
      wireguard_mtu: 'MTU',
      wireguard_persistent_keepalive_interval: '心跳保活(秒)',
  ...
  cdn: {
    ...
    customDomain: {
      title: '自定义域名（可选）',
      subtitle:
        '把 Worker 同时绑定到你 Cloudflare 上的某个域名（例如 relay.example.com）。部分蜂窝网络对 *.workers.dev 有特殊限速 / 阻断，自定义域名能绕过基于域名的指纹识别。',
      enable: '启用自定义域名',
      zone: '选择域名',
      zonePlaceholder: '加载中…',
