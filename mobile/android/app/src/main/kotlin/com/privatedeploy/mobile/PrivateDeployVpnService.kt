...
class PrivateDeployVpnService : VpnService(), Platform {
    ...
    companion object {
        ...
        // Real-world Chinese carriers (China Mobile / Telecom / Unicom)
        ...
        // upstream Healthy. Carriers (notably China Mobile / Telecom / Unicom)
                ...
                try {
                    ...
                    when (health) {
                        ...
                        TunnelHealth.UpstreamDegraded -> {
                            ...
                            if (onCellular) {
                                // Reported 2026-05-20: on China Mobile cellular,
                                ...
                                // SYN-block error (which fires Gate ③ banner
     ...
     * acceleration solves. Emit the SYN-block-flavored message so the
