...
class AppLocalizationsEn extends AppLocalizations {
  ...
  String get cdnGuidanceBody =>
      'Every attempt to reach the configured node failed while on cellular data. Some carriers (notably China Mobile) drop packets to known VPS IPs. Set up CDN acceleration to route through a Cloudflare edge IP that carriers don\'t filter.';
  ...
  @override
  String get routingTagCnAppsDirect => 'CN apps direct';
  ...
  String get routingModeDesc =>
      'LAN direct · CN apps direct · CN domains direct · CN IPs direct';
  ...
  @override
  String get cnOptimizedDns => 'CN optimized DNS';
