...
final _zhContent = _HelpContent(
  ...
  sections: [
    ...
    _SectionData(
      title: '用真实测试数据说明',
      blocks: [
        _Para('测试环境:中国移动 5G,VPN 已断开(直连测试):'),
        _Para('完全连不通(裸 IP):'),
        _CompareTable(
          headers: ('目标 IP', '结果'),
          rows: [
    ...
    _SectionData(
      ...
      blocks: [
        ...
        _Bullet('③ 切到不同的 SIM 卡运营商:中国移动 / 电信 / 联通的封锁策略不同步。'
            '中国移动 5G 在敏感时段封得最狠,电信和联通通常稍宽松。'),
    ...
    _SectionData(
      ...
      blocks: [
        ...
        _Bullet('"为什么我朋友用魔戒就没事?" — 商业 VPN 服务花大力气运维专门规避封锁的中转节点,不是普通自部署能做到的。'),
...
final _enContent = _HelpContent(
  ...
  sections: [
    ...
    _SectionData(
      ...
      blocks: [
        _Para('Test setup: China Mobile 5G, VPN disabled (direct probe):'),
    ...
    _SectionData(
      ...
      blocks: [
        ...
        _Bullet(
          '③ Try a different SIM carrier: China Mobile blocks the hardest, especially during '
    ...
    _SectionData(
      ...
      blocks: [
        ...
        _Bullet(
            '"Why does Mojie/Surge etc. work for my friend?" — Commercial VPN services run constantly-rotated relay infrastructure, which a single self-deployed VPS cannot match.'),
        _Bullet(
