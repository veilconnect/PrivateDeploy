...
/// traffic (to reach a home/office network), runs alongside the 翻墙 proxy
      ...
      child: Padding(
        ...
        child: Column(
          ...
          children: [
            ...
            SizedBox(height: 4.h),
            Text(
              '独立于翻墙节点:只把内网流量(局域网)走 WireGuard,与代理节点同时运行、互不影响。\n'
            ...
            child: Column(
              ...
              children: [
                ...
                _field(_keepalive, '保活间隔秒 / Keepalive',
                    keyboard: TextInputType.number),
                Text(
                  '提示:本地地址所在子网会自动走 WireGuard,额外网段可叠加。其余流量仍走翻墙/直连。\n'
