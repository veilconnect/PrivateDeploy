...
func upcloudCredentials(cfg *cloud.ProviderConfig) (string, string, error) {
	...
	if username == "" || password == "" {
		return "", "", fmt.Errorf("upcloud credentials are incomplete: set API key as 'username:password' or provide extra.username and extra.password")
	}
...
func (p *Provider) loadNodeRecords() (map[string]cloud.InstanceRecord, error) {
	...
	// Backward compatibility for typed nodeRecord map.
